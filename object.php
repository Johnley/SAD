          ...
          <ul class="nav navbar-nav">
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                ...
                <li class="active"><a href="object.php">Objects</a></li>
...
if(isset($_GET['entry'])){
	...
	$display_string .= "<table class=\"table table-nonfluid\">";
	...
	echo $display_string;
	echo "<div class=\"panel-footer\"><a href=\"object.php\">Back</a></div></div>";
...
foreach($phpfiles as $phpfile)
{
	...
	$display_string .= "<a href=\"object.php?entry=".basename($phpfile)."\" class=\"list-group-item\">".$json->shortdescription."</a>";
