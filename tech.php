          ...
          <ul class="nav navbar-nav">
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                ...
                <li class="active"><a href="tech.php">Techs</a></li>
...
if(isset($_GET['entry'])){
	...
	echo $display_string;
	echo "<div class=\"panel-footer\"><a href=\"tech.php\">Back</a></div></div>";
...
foreach($phpfiles as $phpfile)
{
	...
	$display_string .= "<a href=\"tech.php?entry=".basename($phpfile)."\" class=\"list-group-item\">".$json->shortdescription."</a>";
