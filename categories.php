...
<div class="container">
    <div class="row">
        ...
        <div class="col-md-4">
            ...
            <p>These are things. things that go in your inventory, usually coming from other things, like ores and
                dirt.</p>
        ...
        <div class="col-md-4">
            ...
            <p>Hack, slash, and stab your way out of even the worst of planets with these weapons.</p>

            <p><a class="btn btn-default" href="sword.php" role="button">View &raquo;</a></p>
        </div>
    </div>
    <!-- /container -->
