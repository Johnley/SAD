            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="active"><a href="sword.php">Melee Weapons</a></li>
                    </ul>
                </li>
...
<div class="container">
    ...
    if (isset($_GET['entry'])) {
        ...
        $fireTime = $json->fireTime * 10;
        $swingSpeed = $damage[$fireTime];
        $dps = round($swingSpeed * $json->primaryStances->projectile->power);
        ...
        $display_string .= "<tr><td>Icon: </td><td><img src=\"assets/images/" . $json->image . "\"></td></tr>";
        $display_string .= "<tr><td>Rarity: </td><td>" . $json->rarity . "</td></tr>";
        $display_string .= "<tr><td>Kind: </td><td>" . $json->kind . "</td></tr>";
        $display_string .= "<tr><td>Description: </td><td>" . $json->description . "</td></tr>";
        $display_string .= "<tr><td>Sword Details: </td><td><table class=\"table\"><tr><td>Damage: </td><td>" . $json->primaryStances->projectile->power . "</td></tr><tr><td>Swing Speed: </td><td>"  .$swingSpeed. "</td></tr><tr><td>DPS: </td><td>" .$dps. "</td></tr></table></td></tr>";
        $display_string .= "</table>";

        $display_string .= "</div>";

        echo $display_string;
        echo "<div class=\"panel-footer\"><a href=\"sword.php\">Back</a></div></div>";
        ...
        foreach ($phpfiles as $phpfile) {
            ...
            $display_string .= "<a href=\"sword.php?entry=" . basename($phpfile) . "\" class=\"list-group-item\">" . $json->shortdescription . "</a>";
