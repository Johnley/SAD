...
if(isset($_GET['entry'])){
	...
	$display_string .= "<tr><td>Effects: </td><td><table class=\"table\"><tr><td>".$json->effects[0][0]->kind."</td><td>".$json->effects[0][0]->amount."</td></tr><tr><td>".$json->effects[0][2]->kind."</td><td>".$json->effects[0][2]->amount."</td></tr></table></tr>";
